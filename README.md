...
- Go 1.25.4+
- [Orbit Studio VS Code extension](https://www.orbit-os.org/downloads.html) (or `orbit-deploy` CLI)
...
- **TLS certs** — dev files go in `cmd/certs/grpc/`. The Orbit Studio extension installs these certificates automatically.
